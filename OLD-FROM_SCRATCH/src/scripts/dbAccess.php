        ...
        case 'getExersisesInformations':
            ...
            if (true){
                ...
                $sql = "SELECT E.id_EXERCICE, E.titre, E.titre_affiche, E.auPoidsDeCorps, P.repetitions, P.kilos 
                        FROM EXERCICE E 
                        LEFT JOIN (
                            -- Recuperer la dernière performance de l exercice et l utilisateur
                            SELECT id_EXERCICE, date_perf, repetitions, kilos
                            FROM PERFORMANCE
                            WHERE id_UTILISATEUR = ".$_SESSION['userId']."
                            ORDER BY date_perf DESC LIMIT 1
